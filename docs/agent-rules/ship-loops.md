...
Cross-link: ship-loop reference in [`docs/agent-rules/delegation.md`](delegation.md); pause-loop override in [`docs/agent-rules/delegation.md`](delegation.md) § Debug-mode pause-loop; gate semantics + halt prompts in [`docs/agent-rules/merge-gates.md`](merge-gates.md); watcher integration in [`docs/design/smatchet-merge-watcher.md`](../design/smatchet-merge-watcher.md).
