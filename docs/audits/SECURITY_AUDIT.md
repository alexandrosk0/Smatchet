...
>
> **All 33 findings are fixed in the current tree.** Remediation landed via **PR #1566** ("C++ security hardening — remediate SECURITY_AUDIT.md", all six slices) plus follow-ups **#1574 / #1578 / #1581** (spawn-path + screenshot-confinement fixups), **#1592 / #1598** (additional untrusted-JSON bounding in the Linear/GitHub/Jira clients), tracked in [`docs/plans/cpp-security-hardening.md`](../plans/cpp-security-hardening.md). Verified against current source on 2026-07-05:
