...
Terms introduced by the Perforce opt-in layer ([`docs/design/git-to-perforce-migration.md`](design/git-to-perforce-migration.md) Phases 2–6). git/GitHub stays the canonical ship-line; these names cover only the p4-side primitives Smatchet uses for agentic-WIP work.
