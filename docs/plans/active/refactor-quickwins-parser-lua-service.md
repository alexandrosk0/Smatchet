...
- **Bash-driver scenario / screenshot / sanitizer**: `bash scripts/dev/test-theme-roundtrip.sh` + `bash scripts/dev/test-theme-syntax-colors.sh` after commit 1; sanitizer preset build for commit 4.
