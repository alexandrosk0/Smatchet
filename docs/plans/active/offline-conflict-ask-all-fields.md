...
Resolve (UI):
13. [SmatchetOfflineQueueUi.cpp:1098](../../../Source/Core/src/Ui/SmatchetOfflineQueueUi.cpp) `DrawOfflineConflictModal` — branch on `kind` (adf/html | scalar | unverified); add scalar + unverified panes with Use Mine / Use Theirs / edit / Discard.
