...
- **Bash-driver scenario / screenshot / sanitizer**: each new *script* gate ships a `--selftest` with **both** a passing and a **failing** fixture (Slice 3 *is* the meta-assertion of this across all gates); Slice 2's selftest proves the header-vs-leaf-doc WARN fires on a mapped-header-without-doc-touch and stays quiet otherwise.
