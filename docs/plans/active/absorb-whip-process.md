...
>
> **Status**: `active` — precondition SATISFIED 2026-08-06: `docs/plans/verifier-scored-code-review-gate.md` shipped and archived (slice 1 PR #1970, slice 2 PR #1974). The ack schema is now stable at `<mode>\t<sha256>\t<score>\t<recommendation>\t<hard_veto>\t<veto_reason>`, so Phase 4 is unblocked and Phases 1–3 no longer risk churn against a moving schema.
