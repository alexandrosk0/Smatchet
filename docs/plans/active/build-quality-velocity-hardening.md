...
- **Sprint-2 status (as of 2026-06-06):**
  - **Shipped:** #7 (#921), #11+#25 (#922), #22 (#917), #31+#32 (#923), #9/#18-partial + #29-skipped (#925), #14-via-strict-off (#920), coverage `--no-breaks` (#927), **#20/#28 (Core_DX12 json-PCH — measured KEEP, see below)**. #12 batch-1 = 5/8 windows (#926); **#12 batch-2 = 3/3 → 8/8 windows complete** (`feat/hardening-12-batch2`).
  - **Parked (human-gated):** #8/#13 (#929 revival playbook — golden-baseline approval + flake calibration).
  - **Remaining 🟢:** none — #12 batch-2, #20/#28, and **#10 TSan (MVP shipped — see below)** all landed by 2026-06-08. The escalated 🔴 tier is now **#19 FULLY SHIPPED (19a + 19b + 19c — sol2 lifted off `AppController.h`)** + #21 (`Optional<T>`).
  - **Escalated 🔴 (await user):** #19 (pImpl `AppController`) — **19a + 19b + 19c SHIPPED** (see #19 entry below); #21 (`Optional<T>`/`Result`).
