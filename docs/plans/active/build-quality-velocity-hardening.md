...
- **Sprint-2 status (as of 2026-06-06):**
  ...
  - **Remaining 🟢:** none — #12 batch-2, #20/#28, and **#10 TSan (MVP shipped — see below)** all landed by 2026-06-08. Only the escalated 🔴 tier (#19 pImpl, #21 Optional<T>) remains, awaiting user go-ahead.
  - **Escalated 🔴 (await user):** #19 (pImpl `AppController`), #21 (`Optional<T>`/`Result`).
