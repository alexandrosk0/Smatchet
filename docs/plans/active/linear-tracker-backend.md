...
19. `src/AppController.cpp` (~L1878–1922, beside the GitHub/Plane fixture installers): install a `LinearFixtureBackend` factory when `SMATCHET_TEST_LINEAR_BACKEND_FIXTURE` is set and the active tracker is Linear (drives Bucket-E).
