...
- 2026-08-16 · **B1 + B2 · the maintainer-gated branch-protection cluster** · closes `merge-pipeline-01` (P0), `-02` (P0), `-06` (P2) after the maintainer greenlit the full cluster on 2026-08-16.
