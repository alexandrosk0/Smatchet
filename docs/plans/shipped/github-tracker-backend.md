...
All eight items are now shipped. Still deferred (pre-dating this list): `ListProjects` (`GET /user/repos`) returns empty since PR2; Projects v2 custom fields per § Out of scope.
