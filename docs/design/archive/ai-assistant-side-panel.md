...
**Plan status**: closed. Moved to `docs/design/archive/ai-assistant-side-panel.md` via a chore PR after PR #170 merged. Future AI assistant work originates from individual backlog entries rather than this multi-phase plan.
