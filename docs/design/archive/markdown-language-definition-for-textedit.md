...
- Bucket E (ImGui Test Engine) — rig is wired (`docs/design/archive/imgui-test-engine-bucket-e-execution.md`); drag-select replay + Ctrl+C clipboard assertion remain the canonical bucket-E targets for Slice 4 — no test landed in this slice.
