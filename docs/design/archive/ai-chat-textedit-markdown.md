...
- Bucket E (ImGui Test Engine) — rig is wired (`docs/design/archive/imgui-test-engine-bucket-e-execution.md`); coverage of this slice's rendered colorizer per-glyph palette stays deferred to a future targeted test pass, no live backlog entry yet.
