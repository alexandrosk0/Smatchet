...
- Bucket E (ImGui Test Engine) — deferred per `docs/backlog/agent-self-improvement/tooling.md`. Drag-select replay + Ctrl+C clipboard assertion remain the canonical bucket-E targets for Slice 4 once the rig is wired.
