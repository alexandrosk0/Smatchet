...
- **Bucket-E**: pending — rig is wired (`docs/design/applied/imgui-test-engine-bucket-e-execution.md`); rendered-strip test promoted to live P2 in `docs/backlog/agent-self-improvement/tooling.md` (2026-05-20 — DeepSeek auto-clear strip).
