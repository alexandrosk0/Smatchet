...
Cross-link: [`docs/plans/shipped/github-tracker-backend.md`](../plans/shipped/github-tracker-backend.md) § Out of scope § Agentic triage tracker-agnostic refactor (the deferred work this ADR was originally drafted for).
