...
The handoff half of the agentic flow (see [`docs/plans/active/agentic-flow-implementation.md`](../plans/active/agentic-flow-implementation.md) and the architecture rationale in [`docs/plans/active/agentic-coding-handoff.md`](../plans/active/agentic-coding-handoff.md)) spawns an external coding harness to drive an approved `ImplementIssue` proposal through to a merged PR. Two paths exist:
