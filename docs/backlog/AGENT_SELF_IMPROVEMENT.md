...
| process     | 13 | [agent-self-improvement/process.md](agent-self-improvement/process.md) |
| tooling     | 27 | [agent-self-improvement/tooling.md](agent-self-improvement/tooling.md) |
