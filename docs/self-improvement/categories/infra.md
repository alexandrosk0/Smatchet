...
- 2026-06-03 · orchestrator · [infra] · P2 — doc-validation gates (`test-portable-purity` / `test-plan-index` / `test-plan-ref-integrity`) are NON-required, so leaks + INDEX drift + dangling refs merge silently to develop
