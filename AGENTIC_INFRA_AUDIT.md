...
**Opportunities, not defects:** B6/B7 (MCP protocol primitives, registry polish), Proposals **P2/P3** (MCP `resources`/`prompts` primitives), **P6** (Linux doctest lane), **P9** (clangd-index nav). These are design-dependent enhancements, not audit defects — opt-in.
