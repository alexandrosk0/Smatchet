...
**Opportunities, not defects:** B6/B7 (MCP protocol primitives, registry polish), C3 (declared environment capability tiers), Proposals **P2/P3** (MCP `resources`/`prompts` primitives), **P5/P6** (capability tiers + Linux doctest lane), **P9** (clangd-index nav). These are design-dependent enhancements, not audit defects — opt-in.

Two proposals were taken up 2026-07-14:
