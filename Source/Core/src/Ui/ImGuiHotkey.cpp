...
const NamedKey kNamedKeys[] = {
    ...
    {"-", ImGuiKey_Minus, true},
    {",", ImGuiKey_Comma, true},
    {".", ImGuiKey_Period, true},
    {"/", ImGuiKey_Slash, true},
    {";", ImGuiKey_Semicolon, true},
    {"'", ImGuiKey_Apostrophe, true},
    {"`", ImGuiKey_GraveAccent, true},
    {"[", ImGuiKey_LeftBracket, true},
    {"]", ImGuiKey_RightBracket, true},
    {"\\", ImGuiKey_Backslash, true},
    {"Space", ImGuiKey_Space, true},
    {"Enter", ImGuiKey_Enter, true},
    {"Return", ImGuiKey_Enter, false},
    {"Tab", ImGuiKey_Tab, true},
    {"Backspace", ImGuiKey_Backspace, true},
    {"Delete", ImGuiKey_Delete, true},
    {"Del", ImGuiKey_Delete, false},
    {"Escape", ImGuiKey_Escape, true},
    {"Esc", ImGuiKey_Escape, false},
    {"Insert", ImGuiKey_Insert, true},
    {"Ins", ImGuiKey_Insert, false},
    {"Home", ImGuiKey_Home, true},
    {"End", ImGuiKey_End, true},
    {"PageUp", ImGuiKey_PageUp, true},
    {"PgUp", ImGuiKey_PageUp, false},
    {"PageDown", ImGuiKey_PageDown, true},
    {"PgDn", ImGuiKey_PageDown, false},
    {"Up", ImGuiKey_UpArrow, true},
    {"Down", ImGuiKey_DownArrow, true},
    {"Left", ImGuiKey_LeftArrow, true},
    {"Right", ImGuiKey_RightArrow, true},
    ...
    // main-row combos.
    {"Num0", ImGuiKey_Keypad0, true},
    {"Num1", ImGuiKey_Keypad1, true},
    {"Num2", ImGuiKey_Keypad2, true},
    {"Num3", ImGuiKey_Keypad3, true},
    {"Num4", ImGuiKey_Keypad4, true},
    {"Num5", ImGuiKey_Keypad5, true},
    {"Num6", ImGuiKey_Keypad6, true},
    {"Num7", ImGuiKey_Keypad7, true},
    {"Num8", ImGuiKey_Keypad8, true},
    {"Num9", ImGuiKey_Keypad9, true},
    {"NumAdd", ImGuiKey_KeypadAdd, true},
    {"KeypadAdd", ImGuiKey_KeypadAdd, false},
    {"NumSubtract", ImGuiKey_KeypadSubtract, true},
    {"KeypadSubtract", ImGuiKey_KeypadSubtract, false},
    {"NumMultiply", ImGuiKey_KeypadMultiply, true},
    {"KeypadMultiply", ImGuiKey_KeypadMultiply, false},
    {"NumDivide", ImGuiKey_KeypadDivide, true},
    {"KeypadDivide", ImGuiKey_KeypadDivide, false},
    {"NumDecimal", ImGuiKey_KeypadDecimal, true},
    {"NumEnter", ImGuiKey_KeypadEnter, true},
