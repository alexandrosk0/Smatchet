...
GlobalHotkey_Win32::GlobalHotkey_Win32() : impl_(std::make_unique<Impl>()) {} // pimpl — Impl complete here
...
// Stub for non-Windows hosts. The Source/Plugins/Whisper subtree is Windows-gated at
