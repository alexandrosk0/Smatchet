...
Write the helper to `tests/_debug/SmatchetAgentDebug.h` (gitignored). Template — substitute every `__SMATCHET_AGENT_DEBUG_ID__` placeholder with the rolled hex:
