...
**Perf workflow**: when the user asks to optimize / profile / fix FPS / lag / hitch / "slow", read [`.claude/PERF_WORKFLOW.md`](PERF_WORKFLOW.md) and follow it. Don't load it for unrelated tasks.
