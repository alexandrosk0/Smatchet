...
# user login. Phase 4c of `docs/design/applied/smatchet-merge-watcher.md`.
#
...
Register-ScheduledTask `
    ...
    -Settings $settings `
    -RunLevel Limited `
    -Description "Smatchet merge-watcher daemon -- polls registered PRs + auto-merges per docs/design/applied/smatchet-merge-watcher.md" | Out-Null
