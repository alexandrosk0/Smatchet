...
PY="${PYTHON:-python}"
TEST_PORT="${SMATCHET_TEST_PORT:-58814}"
# Substring filter — category prefix "CommandPalette" matches both
# InlineTyping_* variants registered in command_palette_inline_typing.test.cpp.
FILTER="${UI_TEST_FILTER:-CommandPalette}"
...
echo "[test-ui-command-palette-inline-typing] launching ephemeral Smatchet (port $TEST_PORT)..."
