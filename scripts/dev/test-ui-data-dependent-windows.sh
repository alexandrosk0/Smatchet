...
# UI window render-smoke tests (plan #12, batch 1).
# Exercises: Views Dashboard, Bulk Export, Plan Doc Viewer, Performance Window,
# Annotate Analysis (5 windows in DataDependentWindowsSmoke category).
#
# Exit codes:
#   0 — every test passed
...
# 5 tests registered in data_dependent_windows_smoke.test.cpp.
