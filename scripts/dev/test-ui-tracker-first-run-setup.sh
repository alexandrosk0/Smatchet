...
# Passed / Failed.
#
# Covers tests/ui/tracker_first_run_setup.test.cpp:
#   - ExplainerBranchesRenderInBothStates — ticks the real Tracker tab body in
#     both TrackerSetupPure::NeedsSetup branches so an ImGui style-stack
