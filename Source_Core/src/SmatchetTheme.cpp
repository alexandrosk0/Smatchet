...
void SmatchetTheme::ApplyStyle() {
    ...
    colors[ImGuiCol_WindowBg]               = ImVec4(0.12f, 0.12f, 0.14f, 1.00f); // Deeper Charcoal
    ...
    colors[ImGuiCol_CheckMark]              = ImVec4(0.35f, 0.55f, 0.95f, 1.00f); // Blue accent
