...
const TranslationEntry kEntries[] = {
    ...
    {"whisper.preferences.hotkeyReadonly",
     "Hotkey rebinding UI lands in Phase E. The active hotkey is:",
    ...
    {"whisper.preferences.hotkeyRebindButton", "Click to rebind",
     u8"Cliquez pour redéfinir"},
    {"whisper.preferences.hotkeyCapturing",
     "Press a key combo... (Esc to cancel)", u8"Appuyez sur une combinaison... (Échap pour annuler)"},
    ...
    {"whisper.preferences.hotkeyErrorReserved",
     "That combo is reserved by the operating system",
     u8"Cette combinaison est réservée par le système d'exploitation"},
    {"whisper.preferences.hotkeyErrorParse",
     "Could not parse the captured key combo", u8"Impossible d'analyser la combinaison capturée"},
    ...
    {"whisper.preferences.privacyLocal",
     "Local mode: audio stays on your machine; no network call is made.",
     u8"Mode local : l'audio reste sur votre machine ; aucun appel réseau."},
    {"whisper.preferences.privacyCloud",
     "Cloud mode: audio is uploaded to OpenAI for transcription.",
     u8"Mode cloud : l'audio est envoyé à OpenAI pour transcription."},
    {"whisper.preferences.privacyDisabled",
     "Disabled: no microphone access, no network call, no model download.",
    ...
    {"whisper.preferences.hotkeyErrorRebind",
     ...
     u8"Échec de la redéfinition de la touche : "},
    {"whisper.preferences.apiKey.testButton", "Test connection",
     u8"Tester la connexion"},
    ...
    {"whisper.preferences.trim.label", "Trim leading/trailing silence",
     u8"Couper les silences au début et à la fin"},
    {"whisper.preferences.maxClipSec.label", "Max clip length:",
     u8"Durée maximale du clip :"},
    {"whisper.preferences.maxClipSec.unit", "seconds", u8"secondes"},
    {"whisper.preferences.maxClipSec.hint", "(0 = unlimited; max 600)",
     u8"(0 = illimité ; max 600)"},
    {"whisper.preferences.autoSend.label",
     "Auto-send AI chat on punctuation (\".\", \"!\", \"?\")",
     u8"Envoi automatique du chat IA sur ponctuation (« . », « ! », « ? »)"},
    {"whisper.preferences.rerunSetup.button", "Re-run setup banner",
     u8"Relancer la bannière de configuration"},
