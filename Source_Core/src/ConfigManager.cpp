...
constexpr char kDefaultImGuiDockLayoutIni[] =
    ...
    "\n"
    "[Docking][Data]\n"
    "DockSpace         ID=0x08BD597D Window=0x1BBC0F80 Pos=0,22 Size=1920,987 Split=Y Selected=0x7EBEC904\n"
    "  DockNode        ID=0x00000020 Parent=0x08BD597D SizeRef=1920,700 Split=X\n"
    "    DockNode      ID=0x00000010 Parent=0x00000020 SizeRef=0,700\n"
    "    DockNode      ID=0x00000030 Parent=0x00000020 SizeRef=1920,700 Split=X\n"
    "      DockNode    ID=0x00000022 Parent=0x00000030 SizeRef=1600,700 CentralNode=1 Selected=0x7EBEC904\n"
    "      DockNode    ID=0x00000004 Parent=0x00000030 SizeRef=320,700 Selected=0x74648FC6\n"
    "  DockNode        ID=0x0000000A Parent=0x08BD597D SizeRef=1920,300 Selected=0x6A4695A4\n";
